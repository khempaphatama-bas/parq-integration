...
| PARQ-PORTAL-001 | [07_Portal](07_Portal) | Stakeholder static web portal | `07_Portal/` | Libra | Derived navigation and visualization artifact | Current / Updated | MASTER_INDEX.md, TASK_BOARD.md, HANDOFF_LOG.md, PARQ-SOT-001, PARQ-ARCH-001, PARQ-ARCH-004, PARQ-ARCH-005, PARQ-ARCH-006, PARQ-ARCH-007, PARQ-UX-001 | Data-driven HTML/CSS/JSON portal for Product, Business, Vendor, and Management stakeholders. Includes dashboard, deliverables, architecture, diagrams, open questions, risks, dependencies, confirmation-required tracker, and source index. |
